...
document.getElementById("to_be_drawn").innerHTML = "Sketch to be drawn is : " + sketch;
...
function updateCanvas() {
    random_number = Math.floor(array1.len);
    console.log(random_number);
    document.getElementById(to_be_drawn).innerHTML = "Sketch to be drawn is : " + random_number
    background("white");
}
